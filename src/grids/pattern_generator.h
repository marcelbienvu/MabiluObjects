...
const uint16_t kPulseDuration = 1200;  // 8 ticks of the main clock.
...
class PatternGenerator {
 public:
  ...
  static inline PatternGeneratorSettings* mutable_settings() { return &settings_; }
  static inline Options* mutable_options() { return &options_; }
